...
// Print all the Characters in glcdfont.h
...
// Print my name Wenbo Geng
void print_Lab(){
    fillScreen(BLACK);
    drawChar(30, 64, 'E', 0xFFFF, 0x0000, 1);
    drawChar(36, 64, 'E', 0xFFFF, 0x0000, 1);
    drawChar(42, 64, 'C', 0xFFFF, 0x0000, 1);
    drawChar(48, 64, '1', 0xFFFF, 0x0000, 1);
    drawChar(54, 64, '7', 0xFFFF, 0x0000, 1);
    drawChar(60, 64, '2', 0xFFFF, 0x0000, 1);
    drawChar(66, 64, ' ', 0xFFFF, 0x0000, 1);
    drawChar(72, 64, 'L', 0xFFFF, 0x0000, 1);
    drawChar(78, 64, 'a', 0xFFFF, 0x0000, 1);
    drawChar(84, 64, 'b', 0xFFFF, 0x0000, 1);
    drawChar(90, 64, '2', 0xFFFF, 0x0000, 1);
}

void print_Name(){
    fillScreen(BLACK);
    drawChar(36, 64, 'W', WHITE, 0x0000, 1);
    drawChar(42, 64, 'e', WHITE, 0x0000, 1);
    drawChar(48, 64, 'n', WHITE, 0x0000, 1);
    drawChar(54, 64, 'b', WHITE, 0x0000, 1);
    drawChar(60, 64, 'o', WHITE, 0x0000, 1);
    drawChar(66, 64, ' ', WHITE, 0x0000, 1);
    drawChar(72, 64, 'G', WHITE, 0x0000, 1);
    drawChar(78, 64, 'e', WHITE, 0x0000, 1);
    drawChar(84, 64, 'n', WHITE, 0x0000, 1);
    drawChar(90, 64, 'g', WHITE, 0x0000, 1);
}
